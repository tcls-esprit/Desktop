 ...
 */
public class DetailEventConcertController implements Initializable {
    ...
    @FXML
    private JFXTextField labeltypeconcert;
    @FXML
    private JFXTextField labellisteartistes;
    @FXML
     ...
     public void detail (Evenement e)
    {
        ...
        for (Concert c : list)
        {
            if (c.getId()==e.getId())
            {
                labeltypeconcert.setText(c.getType_concert());
                for (String s : c.getArtistes())
                {
                    artiste += s;
                }
            }
        ...
        labellisteartistes.setText(artiste);
        afficher();
        detailSession();
    }
