...
public class PostulerDemandeEventController implements Initializable {
    ...
    private void accepter(ActionEvent event) 
    {
        ...
        if (!nomimage.equals(" "))
            {
            Evenement ev = new Evenement(labelnom.getText(),prix,labeldescription.getText(),duree,CurrentUser.id,0,nomimage,boxtypeevent.getValue());
            ...
            {
            Evenement ev = new Evenement(labelnom.getText(),prix,labeldescription.getText(),duree,CurrentUser.id,0,boxtypeevent.getValue());
            EvenementService es = new EvenementService();
            es.insert(ev);
            alert();
            }
